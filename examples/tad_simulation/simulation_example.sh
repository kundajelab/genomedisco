...
do
    ls -lh $f
    /srv/gsfs0/projects/kundaje/users/oursu/code/anaconda2/mypython/bin/python ../../genomedisco/compute_rw.py --m ${f} --node_file ${nodefile} --mname test --outdir normalized --outpref $(basename ${f}).norm_sqrtvc --tmin 1 --tmax 1 --norm sqrtvc
done