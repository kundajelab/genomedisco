...
Installs all software used for computing reproducibility and quality control for 3D genome data.
OPTIONS
...
#git clone https://github.com/kundajelab/genomedisco ${repo_dir}/software/genomedisco
...
#make a bashrc file
#==================
bashrc_file=${repo_dir}/software/bashrc_3DChromatin_ReplicateQC
